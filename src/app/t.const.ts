const T = {
  ...
  F: {
    ...
    CALDAV: {
      ...
      FORM: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.CALDAV.FORM.IS_AUTO_IMPORT_ISSUES',
    ...
    GITEA: {
      ...
      FORM: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.GITEA.FORM.IS_AUTO_IMPORT_ISSUES',
        IS_AUTO_POLL: 'F.GITEA.FORM.IS_AUTO_POLL',
        IS_SEARCH_ISSUES_FROM_GITEA: 'F.GITEA.FORM.IS_SEARCH_ISSUES_FROM_GITEA',
    ...
    REDMINE: {
      ...
      FORM: {
        ...
        IS_AUTO_POLL: 'F.REDMINE.FORM.IS_AUTO_POLL',
        IS_SEARCH_ISSUES_FROM_REDMINE: 'F.REDMINE.FORM.IS_SEARCH_ISSUES_FROM_REDMINE',
        IS_AUTO_IMPORT_ISSUES: 'F.REDMINE.FORM.IS_AUTO_IMPORT_ISSUES',
      },
      FORM_SECTION: {
    ...
    GITHUB: {
      ...
      FORM: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.GITHUB.FORM.IS_AUTO_IMPORT_ISSUES',
    ...
    GITLAB: {
      ...
      FORM: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.GITLAB.FORM.IS_AUTO_IMPORT_ISSUES',
    ...
    JIRA: {
      ...
      FORM: {
        IS_AUTO_IMPORT_ISSUES: 'F.JIRA.FORM.IS_AUTO_IMPORT_ISSUES',
      ...
      FORM_ADV: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.JIRA.FORM_ADV.IS_AUTO_IMPORT_ISSUES',
    ...
    OPEN_PROJECT: {
      ...
      FORM: {
        ...
        IS_AUTO_IMPORT_ISSUES: 'F.OPEN_PROJECT.FORM.IS_AUTO_IMPORT_ISSUES',
    ...
    TASK: {
      ...
      CMP: {
        ...
        PLAN_FOR_DAY: 'F.TASK.CMP.PLAN_FOR_DAY',
      ...
      D_REMINDER_ADD: {
        ...
        RO_NEVER: 'F.TASK.D_REMINDER_ADD.RO_NEVER',
      ...
      S: {
        ...
        MOVE_TO_PROJECT_NOT_ALLOWED_FOR_ISSUE_TASK:
          'F.TASK.S.MOVE_TO_PROJECT_NOT_ALLOWED_FOR_ISSUE_TASK',
    ...
    TIMELINE: {
      ...
      LUNCH_BREAK: 'F.TIMELINE.LUNCH_BREAK',
    },
    TIME_TRACKING: {
      B: {
  ...
  GCF: {
    ...
    TIMELINE: {
      ...
      L_IS_LUNCH_BREAK_ENABLED: 'GCF.TIMELINE.L_IS_LUNCH_BREAK_ENABLED',
      L_LUNCH_BREAK_END: 'GCF.TIMELINE.L_LUNCH_BREAK_END',
      L_LUNCH_BREAK_START: 'GCF.TIMELINE.L_LUNCH_BREAK_START',
      LUNCH_BREAK_START_END_DESCRIPTION: 'GCF.TIMELINE.LUNCH_BREAK_START_END_DESCRIPTION',
    },
    TRACKING_REMINDER: {
  ...
  PP: {
    ...
    CLICK_TO_HIDE: 'PP.CLICK_TO_HIDE',
    CLICK_TO_SHOW: 'PP.CLICK_TO_SHOW',
    ...
    OPEN_PROJECT_CONFIGURED: 'PP.OPEN_PROJECT_CONFIGURED',
